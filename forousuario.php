      ...
      <div id="content">
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <ul class="navbar-nav ml-auto">
            ...
            <b>
                <center>
                    <font face="Times New Roman" size="8" color="Black">Foro General</font>
                </center>
            </b>
            <b>
        <div style="width: 80%;margin:auto ;margin-top: 80px;">
        <center><img src="img/Foro.jpeg" alt="" width=150" height="60" alt="Responsive image"  class="rounded img-fluid d-inline-block align-text-top"></center>
            <?php
