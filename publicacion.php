    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="formulario">
            <form action="menu_administrador.php" method="post" enctype="multipart/form-data" style="margin-left: 30%;">
                <div>
                ...
                <div>
                    <input type="file" name="imagen-subida" accept="image/png, .jpeg, .jpg, image/gif">
                </div>
